...
Public Class lap_pinjam_bulan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Library.lap_pinjam_bulan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedlap_pinjam_bulan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As lap_pinjam_bulan = New lap_pinjam_bulan()
        rpt.Site = Me.Site
        Return rpt
    End Function
