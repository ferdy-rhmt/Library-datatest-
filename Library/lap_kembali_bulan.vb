...
Public Class lap_kembali_bulan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Library.lap_kembali_bulan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedlap_kembali_bulan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As lap_kembali_bulan = New lap_kembali_bulan()
        rpt.Site = Me.Site
        Return rpt
    End Function
